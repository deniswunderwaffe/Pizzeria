...
namespace Pizzeria.Infrastructure.Migrations
{
    ...
    [Migration("20210909131719_AddedTypeCheckConstraint")]
    partial class AddedTypeCheckConstraint
    {
            ...
            modelBuilder.Entity("Pizzeria.Core.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "test@mail.ru",
                            Name = "Den",
                            OrderedAt = new DateTime(2021, 9, 9, 16, 17, 18, 706, DateTimeKind.Local).AddTicks(1826),
                            PaymentOption = "Cash",
                            Phone = "1234567890",
                            Priority = true
                        });
            ...
            modelBuilder.Entity("Pizzeria.Core.Models.Pizza", b =>
                {
                    ...
                    b.HasCheckConstraint("pizzaType_constraint", "type IN('American','Italian','Japanese')");
            ...
            modelBuilder.Entity("Pizzeria.Core.Models.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Country = "Moldova",
                            FoundationDate = new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Name = "Provider"
                        });
                });
